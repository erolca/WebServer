//Javascript Data Structure Tutorial
/*
* Liste sýralý bir veri dizisidir.
* Listede saklanan her veri öðesine bir öðe denir.
* Öðesi olmayan bir liste boþ bir listedir.
* Bir listede saklanan elemanlarýn sayýsýna listenin uzunluðu denir.
* Bir öðeyi listenin sonuna ekleyebiliriz veya varolan bir öðeden sonra veya listenin baþýna bir öðeyi listeye ekleyebiliriz.
* Öðeler bir kaldýrma iþlemi kullanýlarak listeden silinir.
* Ayrýca, bir listeyi temizleyerek tüm geçerli öðelerinin kaldýrýlmasýný saðlayabiliriz.
* Listenin öðeleri bir toString() iþlemi kullanýlarak görüntülenir.
* GetElement() iþlemi, geçerli öðenin deðerini görüntüler.
* Bir sonraki() iþlemini kullanarak bir listenin bir öðesinden bir sonraki öðeye geçebiliriz ve prev() iþlemini kullanarak bir listede geriye doðru hareket edebiliriz.
* MoveTo(n) iþlemini kullanarak listedeki numaralý konuma da hareket edebiliriz; burada n, taþýnacak konumu belirtir.
* CurrentPosition özelliði, listedeki geçerli konumu gösterir.
*/
